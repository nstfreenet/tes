...
sed -i 's|export KEY_ORG="Fort-Funston"|export KEY_ORG="nstfreenet"|' /etc/openvpn/easy-rsa/vars
sed -i 's|export KEY_EMAIL="me@myhost.mydomain"|export KEY_EMAIL="nstfreenet@gmail.com"|' /etc/openvpn/easy-rsa/vars
sed -i 's|export KEY_OU="MyOrganizationalUnit"|export KEY_OU="IPANG"|' /etc/openvpn/easy-rsa/vars
sed -i 's|export KEY_NAME="ISAL"|export KEY_NAME="ISAL"|' /etc/openvpn/easy-rsa/vars
sed -i 's|export KEY_OU=changeme|export KEY_OU=ISAL|' /etc/openvpn/easy-rsa/vars
